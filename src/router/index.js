...
export const constantRouterMap = [
  ...
  },
  {
    path: '/storehouse',
    component: Layout,
    redirect: '/storehouse/warehouseGoods',
    name: 'storehouse',
    meta: { title: '仓库', icon: 'product' },
    children: [{
      path: 'warehouseGoods',
      name: 'warehouseGoods',
      component: () => import('@/views/storehouse/warehouseGoods/index'),
      meta: { title: '仓库商品', icon: 'product-list' }
    }, {
      path: 'freight',
      name: 'freight',
      component: () => import('@/views/storehouse/freight/index'),
      meta: { title: '运费模板', icon: 'product-list' }
    }, {
      path: 'checkFreight',
      name: 'checkFreight',
      component: () => import('@/views/storehouse/freight/check'),
      meta: { title: '查看运费模板', icon: 'product-list' }
    },
    {
      path: 'updateFreight',
      name: 'updateFreight',
      component: () => import('@/views/storehouse/freight/update'),
      meta: { title: '编辑运费模板', icon: 'product-list' }
    },
    {
      path: 'noDelivery',
      name: 'noDelivery',
      component: () => import('@/views/storehouse/noDelivery/index'),
      meta: { title: '不配送区域模板', icon: 'product-list' }
    },
    {
      path: 'updateNoDelivery',
      name: 'updateNoDelivery',
      component: () => import('@/views/storehouse/noDelivery/update'),
      meta: { title: '编辑不配送区域模板', icon: 'product-list' }
    }]
  },
  {
    path: '/pms',
    ...
    },
    {
      path: 'twoProductCate',
      name: 'twoProductCate',
      component: () => import('@/views/pms/productCate/two'),
      meta: { title: '二级分类' },
      hidden: true
    },
    {
      path: 'threeProductCate',
      name: 'threeProductCate',
      component: () => import('@/views/pms/productCate/three'),
      meta: { title: '三级分类' },
      hidden: true
    },
    {
      path: 'propProductCate',
      name: 'propProductCate',
      component: () => import('@/views/pms/productCate/prop'),
      meta: { title: '分类属性管理' },
      hidden: true
    },
    {
      path: 'propManProductCate',
      name: 'propManProductCate',
      component: () => import('@/views/pms/productCate/components/propMan'),
      meta: { title: '分类属性管理' },
      hidden: true
    },
    {
      path: 'attrProductCate',
      name: 'attrProductCate',
      component: () => import('@/views/pms/productCate/attr'),
      meta: { title: '分类规格管理' },
      hidden: true
    },
    {
      path: 'attrManProductCate',
      name: 'attrManProductCate',
      component: () => import('@/views/pms/productCate/components/attrMan'),
      meta: { title: '分类规格管理' },
      hidden: true
    },
    {
      path: 'productProp',
      name: 'productProp',
      component: () => import('@/views/pms/productProp/index'),
      meta: { title: '属性管理', icon: 'product-attr' }
    },
    {
      path: 'addProductProp',
      name: 'addProductProp',
      component: () => import('@/views/pms/productProp/add'),
      meta: { title: '增加属性', icon: 'product-attr' },
      hidden: true
    },
    {
      path: 'updateProductProp',
      name: 'updateProductProp',
      component: () => import('@/views/pms/productProp/update'),
      meta: { title: '编辑属性', icon: 'product-attr' },
      hidden: true
    },
    {
      path: 'productAttr',
    ...
    },
    {
      path: 'productSpu',
      name: 'productSpu',
      component: () => import('@/views/pms/productSpu/index'),
      meta: { title: '商品spu' },
      hidden: true
    },
    {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'examine',
        name: 'examine',
        component: () => import('@/views/oms/order/examine'),
        meta: { title: '线下支付审核列表', icon: 'product-list' }
      },
      {
        path: 'logistics',
        name: 'logistics',
        component: () => import('@/views/oms/logistics/index'),
        meta: { title: '物流列表', icon: 'product-list' }
      },
      {
        path: 'loadBillList',
        name: 'loadBillList',
        component: () => import('@/views/oms/loadBillList/index'),
        meta: { title: '提货单列表', icon: 'product-list' }
      },
    ...
    children: [
      {
        path: 'weekSettle',
        name: 'weekSettle',
        component: () => import('@/views/sys/sysStoreSettleRecords/index'),
        meta: { title: '周结算报告', icon: 'product-list' }
      },
      {
        path: 'orderPay',
        name: 'orderPay',
        component: () => import('@/views/oms/order/orderPay'),
        meta: { title: '对账流水', icon: 'product-list' }
      },
      {
        path: 'sysShop',
        name: 'sysShop',
    ...
    children: [
      {
        path: 'smsPreSale',
        name: 'smsPreSale',
        component: () => import('@/views/sms/smsPreSale/index'),
        meta: { title: '预售活动列表', icon: 'product-list' }
      },

      {
        path: 'addSmsPreSale',
        name: 'addSmsPreSale',
        component: () => import('@/views/sms/smsPreSale/add'),
        meta: { title: '添加预售活动' },
        hidden: true
      },
      {
        path: 'updateSmsPreSale',
        name: 'updateSmsPreSale',
        component: () => import('@/views/sms/smsPreSale/update'),
        meta: { title: '编辑预售活动' },
        hidden: true
      },
      ...
      ,
      {
        ...
        meta: { title: '套餐商品', icon: 'product-list' }
      },
    ...
    children: [
      {
        path: 'fenxiaoOrder',
        name: 'fenxiaoOrder',
        component: () => import('@/views/oms/order/fenxiaoOrder'),
        meta: { title: '分销订单列表', icon: 'product-list' }
      },
      {
        path: 'fenxiaoChecks',
        name: 'fenxiaoChecks',
  ...
  },
  {
    path: '/assets',
    component: Layout,
    redirect: '/assets/issue',
    name: 'assets',
    meta: { title: '资产', icon: 'home' },
    children: [
      {
        path: 'issue',
        name: 'issue',
        component: () => import('@/views/assets/issue/index'),
        meta: { title: '酒证发行', icon: 'product-list' }
      },
      {
        path: 'receipt',
        name: 'receipt',
        component: () => import('@/views/assets/receipt/index'),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '会员详情', icon: 'product-list' }
      },
      {
        path: 'assets',
        name: 'assets',
        component: () => import('@/views/ums/assets'),
        meta: { title: '酒证资产', icon: 'product-list' }
      },
      ...
      },
      {
        path: 'setMemberLevel',
        name: 'setMemberLevel',
        component: () => import('@/views/ums/memberLevel/set'),
        meta: { title: '设置会员等级' },
        hidden: true
      },
      {
    ...
    children: [
      {
        path: 'ossSetting',
        name: 'ossSetting',
        component: () => import('@/views/sys/yunsetting'),
        meta: { title: '图片配置', icon: 'product-list' }
      },
      {
        path: 'basicinfo',
        name: 'basicinfo',
        component: () => import('@/views/sys/basicSetting'),
      ...
      },
      {
        path: 'omsPayments',
        name: 'omsPayments',
        component: () => import('@/views/sys/paySetting'),
    ...
    children: [
      {
        path: 'mailbox',
        name: 'mailbox',
        component: () => import('@/views/sys/mailbox/index'),
        meta: { title: '邮箱管理', icon: 'product-list' }
      },
      {
        path: 'account',
        name: 'account',
        component: () => import('@/views/sys/account/index'),
        meta: { title: '账户管理', icon: 'product-list' }
      },
      {
        path: 'adminSysNotice',
        name: 'adminSysNotice',
        component: () => import('@/views/sys/adminSysNotice/index'),
        meta: { title: '商城通知列表', icon: 'product-list' }
      },

      {
        path: 'addAdminSysNotice',
        name: 'addAdminSysNotice',
        component: () => import('@/views/sys/adminSysNotice/add'),
        meta: { title: '添加商城通知' },
        hidden: true
      },
      {
        path: 'updateAdminSysNotice',
        name: 'updateAdminSysNotice',
        component: () => import('@/views/sys/adminSysNotice/update'),
        meta: { title: '编辑商城通知' },
        hidden: true
      },
      {
...

  {
    path: '/platformTotal',
    component: Layout,
    redirect: '/platformTotal/addMember',
    name: 'platformTotal',
    meta: { title: '报表统计', icon: 'home' },
    children: [
      {
        path: 'addMember',
        name: 'addMember',
        component: () => import('@/views/platformTotal/addMember'),
        meta: { title: '新增会员', icon: 'product-list' }
      },
      {
        path: 'memberTotal',
        name: 'memberTotal',
        component: () => import('@/views/platformTotal/memberTotal'),
        meta: { title: '会员统计', icon: 'product-list' }
      },
      {
        path: 'addGoods',
        name: 'addGoods',
        component: () => import('@/views/platformTotal/addGoods'),
        meta: { title: '新增商品', icon: 'product-list' }
      },
      {
        path: 'goodsTotal',
        name: 'goodsTotal',
        component: () => import('@/views/platformTotal/goodsTotal'),
        meta: { title: '商品统计', icon: 'product-list' }
      },
      {
        path: 'addOrder',
        name: 'addOrder',
        component: () => import('@/views/platformTotal/addOrder'),
        meta: { title: '新增订单', icon: 'product-list' }
      },
      {
        path: 'orderTotal',
        name: 'orderTotal',
        component: () => import('@/views/platformTotal/orderTotal'),
        meta: { title: '订单统计', icon: 'product-list' }
      },
    ]
  },
