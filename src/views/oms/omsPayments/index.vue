<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表【1为微信支付宝配置,id为2的是支付宝配置,代码中写死，如果需要添加支付方式 可以数据库提前初始化 】</span>
      <span>参数文档 https://javen205.gitee.io/ijpay/guide/config/alipay_config.html</span>
    </el-card>
...
<script>
  //将$都替换为$
  import {fetchList, deleteOmsPayments,updateShowStatus} from '@/api/oms/omsPayments'
