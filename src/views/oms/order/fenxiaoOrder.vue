    ...
    <div class="table-container">
      <el-table ref="orderTable"
        ...
        <el-table-column label="订单类型" width="120" align="center">
          <template slot-scope="scope">{{scope.row.orderType | formatOrderType}}
...
<script>
  import {fetchFenxiaoList,closeOrder,deleteOrderById} from '@/api/order'
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        fetchFenxiaoList(this.listQuery).then(response => {
