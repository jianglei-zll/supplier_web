<template>
  <div style="margin-top: 50px">
    ...
    >
      ...
      <el-form-item label="年份：" prop="production" >
        <el-input style="width:215px" v-model="value.production" onkeyup="value=value.replace(/[^\d]/g,'')" ></el-input>
        <span >年</span>
      </el-form-item>
      <el-form-item label="商品类型：" prop="type">
        <el-select v-model="value.type" placeholder="请选择商品类型">
          <el-option :key="0" label="虚拟" :value="0"> </el-option>
          <el-option :key="1" label="实体" :value="1"> </el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="商品售价：" >
        <el-input v-model="value.price" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="7"></el-input>
      </el-form-item>
      <el-form-item label="市场价：" maxlength=7>
        <el-input v-model="value.originalPrice" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="7"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getFeightTemplateList() {
      fetchFeightTemplateList({ pageNum: 1, pageSize: 100 }).then(
        (response) => {
