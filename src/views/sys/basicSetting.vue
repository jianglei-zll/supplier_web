   ...
   import {
    ...
    export default {
        ...
        created() {
                ...
                getSysSystemSetting(1).then(response => {
                    this.sysSystemSetting = response.data;
            })
                ;
            ...
            onSubmit(formName) {
                this.$refs[formName].validate((valid) => {
                    if(valid) {
                        ...
                        {
                            updateSysSystemSetting(this.$route.query.id, this.sysSystemSetting).then(response => {
                        ...
                        {
                            updateSysSystemSetting(1,this.sysSystemSetting).then(response => {
                                if(response.code == 200
                        )
                            {
                                this.$refs[formName].resetFields();
