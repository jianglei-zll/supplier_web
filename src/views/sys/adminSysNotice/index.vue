    ...
    <div class="app-container">
        <el-card class="filter-container" shadow="never">
            <div>
                ...
                <el-button
                        style="float: right"
                        @click="searchAdminSysNoticeList()"
                        type="primary"
                        size="small">
                    查询结果
                </el-button>
        ...
        <el-card class="operate-container" shadow="never">
            ...
            <el-button
                    class="btn-add"
                    @click="addAdminSysNotice()"
                    size="mini">
                添加
            </el-button>
        </el-card>
        <div class="table-container">
            <el-table ref="adminSysNoticeTable"
                      :data="list"
                      style="width: 100%"
...
<script>
    //将$都替换为$
    import {fetchList, deleteAdminSysNotice,updateShowStatus} from '@/api/sys/adminSysNotice'
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdate(index, row) {
                this.$router.push(
                    {path: '/sys/updateAdminSysNotice', query: {id: row.noticeId}})
            },
            ...
            addAdminSysNotice() {
                //手动将router,改成$router
                this.$router.push({path: '/sys/addAdminSysNotice'})
            }
        }
    }
</script>
