  ...
  <div>
    <el-card class="login-form-layout">
      ...
      >
        ...
        <h2 class="login-title color-main">{{ basicInfo.siteName }}入驻</h2>
        ...
        <el-form-item label="负责人" prop="contactName">
          <el-input v-model="storeForm.contactName" style="width: 320px" />
        </el-form-item>
        ...
        <el-form-item prop="contactMobile">
          <el-input
            v-model="storeForm.contactMobile"
            style="width: 320px"
            placeholder="请输入服务电话"
          />
        </el-form-item>
